...
const IntroSection = () => {
  ...
  const content = {
    pt: {
      ...
      description: "Especialista em criar experiências digitais dinâmicas e intuitivas com Angular, TypeScript e tecnologias modernas. Com mais de 5 anos de experiência, desenvolvo aplicações web responsivas que unem design elegante e funcionalidade robusta.",
    ...
    en: {
      ...
      description: "Specialist in creating dynamic and intuitive digital experiences with Angular, TypeScript and modern technologies. With over 5 years of experience, I develop responsive web applications that combine elegant design and robust functionality.",
    ...
    es: {
      ...
      description: "Especialista en crear experiencias digitales dinámicas e intuitivas con Angular, TypeScript y tecnologías modernas. Con más de 5 años de experiencia, desarrollo aplicaciones web responsivas que combinan diseño elegante y funcionalidad robusta.",
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4 text-foreground">
              {currentContent.greeting} <span className="text-primary">Carolina Farias Macioti</span>
            </h1>
