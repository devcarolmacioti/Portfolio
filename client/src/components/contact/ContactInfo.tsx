...
const ContactInfo = () => {
  ...
  const texts = {
    ...
    en: {
      ...
      location: "Location",
      phone: "Phone",
      locationText: "Porto Alegre, RS - Brazil",
  ...
  return (
    <div className="bg-card text-card-foreground p-8 rounded-lg shadow-md h-full">
      ...
      <div className="space-y-6">
        <div className="flex items-start">
          ...
          <div>
            ...
            <a
              href="mailto:carolmacioti.dev@gmail.com"
              className="text-primary hover:underline"
            >
              carolmacioti.dev@gmail.com
            </a>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-foreground/80">(53) 99905-8243</p>
          </div>
        </div>
      </div>
      ...
      <h3 className="text-xl font-heading font-medium mb-4 text-foreground">
        {currentText.socialMedia}
      </h3>
      <div className="flex space-x-4">
        <a
          href="https://www.linkedin.com/in/carolina-macioti-dev/"
          target="_blank"
        ...
        <a
          href="https://github.com/carolmacioti"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-primary/10 p-3 rounded-full text-primary hover:bg-primary hover:text-white transition-all"
          aria-label="GitHub"
        ...
        <a
          href="https://www.instagram.com/lina_developer/"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-primary/10 p-3 rounded-full text-primary hover:bg-primary hover:text-white transition-all"
