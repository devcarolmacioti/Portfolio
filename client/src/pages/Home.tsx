    ...
    pt: [
      {
        ...
        period: "Em andamento",
        skills:
          "HTML | CSS | JavaScript | React | TypeScript | Next.Js | Vue.Js | UI Design",
      },
      {
      ...
      },
      {
        ...
        period: "2019",
        skills:
          "Comunicação oral e escrita | Raciocínio lógico e jurídico | Argumentação e redação juridica | Colaboração",
      },
    ],
    en: [
      {
      ...
      },
      {
        ...
        period: "2019",
        skills:
          "Oral and written communication | Logical and legal reasoning | Legal argumentation and writing | Collaboration",
      },
    ],
    es: [
      {
      ...
      },
      {
        ...
        period: "2019",
        skills:
          "Comunicación oral y escrita | Razonamiento lógico y jurídico | Argumentación y redacción jurídica | Colaboración",
      },
    ],
  };
...
const TechnologiesSection = () => {
  ...
  const technologiesData = [
    ...
    { name: "UI DESIGN", icon: <SiFigma size={32} /> },
  ];
